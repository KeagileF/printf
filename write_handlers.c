...
/***** NUMBER *************/
/**
 * handle_number - A func that prints num
 ...
 * @ind: Where the num starts at the buffer
 * @buffer: Buffer
 * @flags: Flags
 * @width: width
 * @prec: Precision
...
/**
 * write_unsgnd - A func that writes an unsigned num
 * @is_negative: checks neg sum
 * @ind: Where num starts at buffer
 * @buffer: buffer
 * @flags: Flags
 * @width: Width
 * @precision: Precision
...
/**
 * write_pointer - A func that Writes a memory address
 * @buffer: Buffer
 * @ind: where num starts in the buffer
 * @length: Length
 * @width: width
 * @flags: Flags
